...
if [ ! -f inputs/bmp-sedfil.out ]; then
    ...
    mv inputs/bmp-sedfil.out ${OUTPUTS5}
fi
...
if [ ! -f inputs/septic.out ]; then
    ...
    mv inputs/septic.out ${OUTPUTS10}
fi
...
if [ ! -f inputs/bmp-ri.out ]; then
    ...
    mv inputs/bmp-ri.out ${OUTPUTS12}
fi
