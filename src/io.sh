...
## PARAMETERS VARIABLES
if [ ! -f inputs/basins.bsn.bk ]; then
  cp inputs/basins.bsn inputs/basins.bsn.bk
fi

envsubst < inputs/basins.bsn.bk> inputs/basins.bsn
rm inputs/basins.bsn.bk
